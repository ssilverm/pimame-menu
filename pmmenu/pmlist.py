...
class PMList(pygame.sprite.OrderedUpdates):
	...
	def __init__(self, rom_list, global_opts, get_labels = False):
		...
		self.rom_template = PMLabel('', global_opts.rom_list_font, global_opts.rom_list_font_color, global_opts.rom_list_background_color, global_opts.rom_list_font_bold, global_opts.rom_list_offset, create_romlist_image, False, min_scale_size)
		
		self.selected_rom_template = PMLabel('', global_opts.rom_list_font, global_opts.rom_list_font_selected_color, global_opts.rom_list_background_selected_color, global_opts.rom_list_font_selected_bold, global_opts.rom_list_offset, create_romlist_selected, False, min_scale_size)
	...
	def build_labels(self, rom_list):
		...
		for list_item in rom_list:
			label = PMLabel(list_item['title'], self.global_opts.rom_list_font, self.global_opts.rom_list_font_color, self.global_opts.rom_list_background_color, self.global_opts.rom_list_font_bold, self.global_opts.rom_list_offset, False, self.rom_template, [], self.global_opts.rom_list_font_align)
